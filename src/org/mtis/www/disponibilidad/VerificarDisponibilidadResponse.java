...
/**
 * VerificarDisponibilidadResponse.java
 *
 ...
 */
            ...
            /**
            *  VerificarDisponibilidadResponse bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":VerificarDisponibilidadResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "VerificarDisponibilidadResponse",
    ...
    public static class Factory{
        ...
        */
        public static VerificarDisponibilidadResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            VerificarDisponibilidadResponse object =
                new VerificarDisponibilidadResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"VerificarDisponibilidadResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (VerificarDisponibilidadResponse)org.mtis.www.disponibilidad.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
