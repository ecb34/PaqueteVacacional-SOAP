 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":VerificarUsuario",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "VerificarUsuario",
    ...
    public static class Factory{
        ...
        */
        public static VerificarUsuario parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            VerificarUsuario object =
                new VerificarUsuario();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"VerificarUsuario".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (VerificarUsuario)org.mtis.www.usuario.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
