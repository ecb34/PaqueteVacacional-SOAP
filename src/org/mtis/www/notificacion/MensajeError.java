 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static MensajeError parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MensajeError object =
                new MensajeError();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MensajeError".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MensajeError)org.mtis.www.notificacion.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
